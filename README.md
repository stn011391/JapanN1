...
- 每級 1,000 題，共 5,000 題分級題庫
- 每次依固定比例隨機抽取 20 題（8 題單字漢字、6 題文法、6 題閱讀）
- 每次開始自動換新題，以「題幹＋文章＋正解」內容指紋阻止實質重複
- 每級含 400 題單字漢字、300 題文法與 300 題閱讀
- 同級連續 50 次測驗、共 1,000 題不重複，完成後才自動開始新一輪
- 單字・漢字、文法、閱讀三類題型
- 依級別設定 20～40 分鐘倒數計時
- 每題即時中文解析
- 分類正確率與弱點分析
...
- **app/reading-generator.ts**：各級情境閱讀文章與題目產生器
- **app/question-selection.ts**：20 題隨機抽題、內容指紋與 1,000 題不重複循環
